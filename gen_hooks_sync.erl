...
add(Module, Function, Arity) ->
	gen_server:call(gen_hooks, {add ,Module, Function, Arity}).
...
delete(Module, Function, Arity) ->
	gen_server:call(gen_hooks, {delete, Module, Function, Arity}).
...
invoke(Module, Function, Arguments) ->
	gen_server:call(gen_hooks, {invoke, Module, Function, Arguments}, infinity).
